      ...
      <SafeAreaView className="flex-1 bg-black items-center justify-center px-8">
        ...
        <View className="mt-4">
          ...
          <CustomText variant="p-small" className="text-center mt-1">
            Check backend is running and endpoint GET /characters returns active
            rows.
          </CustomText>
        </View>
